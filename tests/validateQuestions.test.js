...
const valid = { question: 'Q?', a: { answer: 'A', correct: true }, b: { answer: 'B' } };
...
describe('validateQuestions', () => {
  ...
  it('accepts correct on side B', () => {
    const q = { question: 'Q?', a: { answer: 'A' }, b: { answer: 'B', correct: true } };
    expect(validateQuestions([q])).toEqual([]);
  });

  it('errors on missing question text', () => {
    const q = { a: { answer: 'A', correct: true }, b: { answer: 'B' } };
